...
class IsSecurityAdmin(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        return (
            ...
            and request.user.has_perm("security.view_auditlog")
        )
...
class CanManageSecurityEvents(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        return (
            request.user
            and request.user.is_authenticated
            and request.user.has_perm("security.change_securityevent")
        )
...
class CanManageSecuritySettings(permissions.BasePermission):
    ...
    def has_permission(self, request, view):
        return (
            request.user
            and request.user.is_authenticated
            and request.user.has_perm("security.change_securitysettings")
        )
...
class CanManageAPIKeys(permissions.BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        return (
            request.user
            and request.user.is_authenticated
            and request.user.has_perm("security.change_apikey")
        )
