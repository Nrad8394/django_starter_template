    ...
    def validate_variables(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                _("Variables must be a valid JSON object")
            )
        return value
...
class NotificationSerializer(serializers.ModelSerializer):
    ...
    recipient_username = serializers.CharField(
        source="recipient.get_username", read_only=True
    )
...
class NotificationEventSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "default_push_template_name",
            "default_in_app_template",
            "default_in_app_template_name",
            "is_active",
            "created_at",
            "updated_at",
        ]
...
class SendNotificationSerializer(serializers.Serializer):
    ...
    scheduled_at = serializers.DateTimeField(
        required=False, help_text=_("When to send the notification (optional)")
    )
    ...
    def validate_template_id(self, value):
        ...
        try:
            ...
            raise serializers.ValidationError(
                _("Template does not exist or is not active")
            )
        except ValueError:
...
class BulkNotificationSerializer(serializers.Serializer):
    ...
    notification_ids = serializers.ListField(
        child=serializers.UUIDField(), help_text=_("List of notification IDs")
    )
    ...
    def validate_notification_ids(self, value):
        ...
        try:
            ...
            if missing_ids:
                raise serializers.ValidationError(
                    _("Notifications with IDs {} do not exist").format(
                        list(missing_ids)
                    )
                )
