...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        default=dict,
                        help_text="JSON schema defining required template variables",
                    ),
                ),
                (
                    "priority",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("weekly_attendance_summary", "Weekly Attendance Summary"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "data",
                    models.JSONField(
                        default=dict, help_text="Template variables and additional data"
                    ),
                ),
                (
                    "status",
        ...
        migrations.AddIndex(
            model_name="notification",
            index=models.Index(
                fields=["status", "priority"], name="notificatio_status_e1eb7a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notification",
