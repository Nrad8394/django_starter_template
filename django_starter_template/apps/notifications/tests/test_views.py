...
class TestNotificationTemplateViewSet:
    ...
    def setup_method(self):
        ...
        self.template_sms = NotificationTemplate.objects.create(
            name="sms_template", template_type="sms", body="SMS content"
        )
    ...
    def test_retrieve_template(self):
        ...
        self.client.force_authenticate(user=self.admin_user)
        url = reverse(
            "notification-template-detail", kwargs={"pk": self.template_email.pk}
        )
    ...
    def test_delete_template(self):
        ...
        template = NotificationTemplate.objects.create(
            name="delete_template", template_type="email", body="Delete me"
        )
        self.client.force_authenticate(user=self.admin_user)
    ...
    def setup_method(self):
        ...
        try:
            self.notification = Notification.objects.create(
                recipient=self.regular_user, template=self.template, status="pending"
            )
        finally:
            # Reconnect signal
...
class TestNotificationDeliveryViewSet:
    ...
    def setup_method(self):
        ...
        self.template = NotificationTemplate.objects.create(
            name="delivery_template", template_type="email", body="Test body"
        )
        self.notification = Notification.objects.create(
            recipient=self.user, template=self.template
        )
