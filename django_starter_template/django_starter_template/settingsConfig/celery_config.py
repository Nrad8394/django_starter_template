...
CELERY_WORKER_MAX_TASKS_PER_CHILD = (
    100  # Restart worker after tasks to prevent memory issues
)
...
CELERY_BROKER_CONNECTION_MAX_RETRIES = 10  # Retry broker connections
CELERY_BROKER_CONNECTION_RETRY_DELAY = 1  # Delay between retries in seconds
